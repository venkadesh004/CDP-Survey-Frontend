...
const routeAddresses = "courseExitSurvey/postData";

const _urlAddress = urlAddress;
export { _urlAddress as urlAddress };
const _routeAddresses = routeAddresses;
export { _routeAddresses as routeAddresses };
