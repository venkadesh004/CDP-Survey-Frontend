...
const CourseExitSurvey = () => {
  ...
  const homeButtonStyle =
    "w-fit px-4 bg-red-500 py-1 rounded-md text-white font-semibold border-2 border-white hover:bg-white hover:text-red-500 hover:border-red-500 duration-200";

  return (
    <div>
      <div className="w-3/4 flex flex-col justify-center  mx-auto h-100v m-10">
        <div className="h-70v">
              ...
              <section>
                <form
                  onSubmit={handleSubmit(async (data, e) => {
                    console.log(data);
                    console.log(urlAddress + routeAddresses);
                    setLoading(true);
                    await axios
                      .post(urlAddress + routeAddresses, data)
                      .then((response) => {
